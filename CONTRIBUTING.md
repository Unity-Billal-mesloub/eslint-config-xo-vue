...
When contributing to this repository, please first discuss the change you wish to make via [github issues](https://github.com/Unity-Billal-mesloub/eslint-config-xo-vue/issues), maybe someone has the same idea as you and just up-voting would be a contribution towards prioritisation. You may also find the work has already begun and you can help by teaming up with another contributor.

Please note we have a [code of conduct](#code-of-conduct), please follow it in all your interactions with the project.

## Pull Request Process

1. Checkout [github issues](https://github.com/Unity-Billal-mesloub/eslint-config-xo-vue/issues) to see if your request has already been made
2. [Raise a bug](https://github.com/Unity-Billal-mesloub/eslint-config-xo-vue/issues/new?assignees=&labels=&template=bug_report.md&title=) or [feature request](https://github.com/Unity-Billal-mesloub/eslint-config-xo-vue/issues/new?assignees=&labels=&template=feature_request.md&title=) using the appropriate [template](https://github.com/Unity-Billal-mesloub/eslint-config-xo-vue/issues/new/choose).
...
4. Create a branch, and make it happen :persevere:
   ...
   - Linted according to the [xo config](https://github.com/Unity-Billal-mesloub/xo) with `yarn lint:fix`
